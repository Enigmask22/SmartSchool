...
Module core cho backend_modular
"""
...
def setup_logger(name: str = "smart_school_modular", level: str = "INFO") -> logging.Logger:
    """
    ...
    log_file = os.path.join(log_dir, f"smart_school_modular_{datetime.now().strftime('%Y%m%d')}.log")
