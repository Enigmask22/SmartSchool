/**
 * E2E Test Suite: TS-HOM04-11 - Face Management Happy Path
 *
 * Scope: Happy path only (E2E scope rule).
 *   Homeroom teacher logs in and views the face management page.
 *
...
test.describe('TS-HOM04-11: Face Management E2E', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto('/homeroom/faces');
  ...
  test('TS-HOM04-11: Homeroom teacher can view face management page', async ({ page }) => {
    // Verify the face management page title is visible
    await expect(
      page.locator('text=Quản lý khuôn mặt AI').first()
