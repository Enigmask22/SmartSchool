/**
 * E2E Test Suite: TS-HOM01-08 - Homeroom Dashboard Happy Path
 *
 * Scope: Happy path only (E2E scope rule).
 *   Homeroom teacher logs in and views the dashboard.
 *
...
test.describe('TS-HOM01-08: Homeroom Dashboard E2E', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    // Wait for token to appear in localStorage (login completed)
  ...
  test('TS-HOM01-08: Homeroom teacher can view dashboard', async ({ page }) => {
    // Verify the dashboard title is visible
    await expect(
      page.locator('text=Tổng quan lớp chủ nhiệm').first()
