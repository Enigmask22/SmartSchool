...
import { BarChart3, TrendingUp, AlertTriangle, Trophy, TrendingDown, Target, Users, GraduationCap, Calendar, BookOpen, Award } from 'lucide-react';
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="p-8 text-center bg-white rounded-2xl border-2 border-red-200 shadow-lg">
          ...
          <p className="font-medium text-red-600">Không thể tải dữ liệu phân tích. Vui lòng thử lại.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-600">Chào mừng <span className="font-semibold text-blue-600">{user?.full_name}</span></p>
        ...
        <div className="p-6 bg-white rounded-2xl border-l-4 border-blue-500 shadow-lg transition-shadow duration-200 hover:shadow-xl">
          <div className="flex justify-between items-center">
             <div>
               ...
               <h3 className="mt-2 text-4xl font-bold text-blue-600">{analytics.total_classes}</h3>
        ...
        <div className="p-6 bg-white rounded-2xl border-l-4 shadow-lg transition-shadow duration-200 border-slate-500 hover:shadow-xl">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h3 className="mt-2 text-4xl font-bold text-slate-700">{analytics.total_students}</h3>
        ...
        <div className="p-6 bg-white rounded-2xl border-l-4 border-emerald-500 shadow-lg transition-shadow duration-200 hover:shadow-xl">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h3 className="mt-2 text-4xl font-bold text-emerald-600">{analytics.overview?.average_score || 0}</h3>
              <p className="mt-1 text-xs text-gray-500">
        ...
        <div className="p-6 bg-white rounded-2xl border-l-4 border-amber-500 shadow-lg transition-shadow duration-200 hover:shadow-xl">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h3 className="mt-2 text-4xl font-bold text-amber-600">{analytics.overview?.pass_rate || 0}%</h3>
              <p className="mt-1 text-xs text-gray-500">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">STT</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Mã HS</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Họ và tên</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Lớp</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">Điểm TB</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">Phân loại</th>
                  </tr>
                </thead>
                    ...
                    <tr>
                      <td colSpan="6" className="px-6 py-12 text-center">
                        <div className="flex flex-col justify-center items-center">
                          ...
                          <p className="font-medium text-gray-600">Tuyệt vời! Không có học sinh nào cần quan tâm đặc biệt</p>
                        </div>
                      </td>
                    </tr>
                  )}
          ...
          <div className="overflow-hidden bg-white rounded-2xl shadow-lg">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Hạng</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Mã HS</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Họ và tên</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Lớp</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">Điểm TB</th>
                    ...
                    <tr>
                      <td colSpan="5" className="px-6 py-12 text-center">
                        <div className="flex flex-col justify-center items-center">
                          ...
                          <p className="font-medium text-gray-600">Chưa có học sinh xuất sắc</p>
                        </div>
                      </td>
                    </tr>
                  )}
              ...
              <table className="min-w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Hạng</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Lớp</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">Sĩ số</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">ĐTB</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">Cao nhất</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">Thấp nhất</th>
                    <th className="px-6 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase">Tỷ lệ đạt</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                      <td colSpan="7" className="px-6 py-12 text-center">
                        <div className="flex flex-col justify-center items-center">
                          ...
                          <p className="font-medium text-gray-600">Chưa có dữ liệu để so sánh</p>
                        </div>
                      </td>
                    </tr>
                  )}
