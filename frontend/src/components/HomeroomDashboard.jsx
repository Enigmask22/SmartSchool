...
const HomeroomDashboard = () => {
  ...
  const fetchAttendanceRecords = useCallback(async () => {
    try {
      ...
      const response = await api.getFullAttendanceList(selectedDate, homeroomInfo?.class_name);
      if (response.success) {
  ...
  }, [selectedDate, homeroomInfo?.class_name]);
  ...
  }, [fetchAttendanceStats, fetchAttendanceRecords]);
  ...
  }, [selectedDate, fetchAttendanceStats, fetchAttendanceRecords]);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-600">
          {homeroomInfo ? `Lớp ${homeroomInfo.class_name} - ${homeroomInfo.grade}` : 'Đang tải thông tin lớp...'}
        </p>
      </div>
