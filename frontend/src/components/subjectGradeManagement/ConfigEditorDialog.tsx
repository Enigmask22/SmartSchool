...
import { Settings, Plus, Save, Trash2, BarChart3, FileEdit, Scale } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
interface ConfigEditorDialogProps {
  ...
  getSortedColumnNames: (config: ConfigForm) => string[];
  onConfigInputChange: (columnName: string, field: string, value: string | number) => void;
  onAddColumn: () => void;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
                      ...
                      <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              onConfigInputChange(columnName, "label", e.target.value)
                            }
        ...
        <DialogFooter className="flex justify-between">
          <Button onClick={onAddColumn} className="flex items-center space-x-2">
